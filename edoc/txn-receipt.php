...
<body>
  ...
  $fetchInvoices = FETCH_TABLE_FROM_DB("$ReqSql", true);
            ...
            <tr>
              ...
              <td>
                <p style="margin-left:1rem;">
                  ...
                  $GetAddress = FETCH_TABLE_FROM_DB("SELECT * FROM user_addresses WHERE UserAddressUserId='$UserTxnMainUserId' ORDER BY UserAddressId DESC limit 1", true);
                  if ($GetAddress != null) {
          ...
          <table style="width:100%;margin-top:5px;">
            <tr>
              ...
              <td>
                ...
                <span><?php echo DATE_FORMATE("d M, Y", FETCH("$ReqSql", "UserTxnDate")); ?></span>
              </td>
              <td>
                <b style="color:black;">Txn Created At</b><br>
                <span><?php echo DATE_FORMATE("d M, Y", FETCH("$ReqSql", "UserTxnCreatedAt")); ?></span>
              </td>
            </tr>
            <tr>
              <td>
