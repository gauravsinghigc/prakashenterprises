            ...
            <table style="width:100%;">
                <tr>
                    <td>
                        ...
                        <p>
                            <span>
                                <span><b>Invoice RefId : </b><?php echo DATE_FORMATE("d/m/Y/", FETCH("SELECT * FROM invoices where InvoiceId='$InvoiceId'", "InvoiceCreatedAt")); ?><?php echo FETCH("SELECT * FROM invoices where InvoiceId='$InvoiceId'", "InvoiceCustomerId"); ?></span><br>
                                <span><b>Invoice date : </b><?php echo DATE_FORMATE("d m, Y", FETCH("SELECT * FROM invoices where InvoiceId='$InvoiceId'", "InvoiceDate")); ?></span><br>
                                ...
                                <span><b>Invoice Created At : </b><?php echo DATE_FORMATE("d M, Y", FETCH("SELECT * FROM invoices where InvoiceId='$InvoiceId'", "InvoiceCreatedAt")); ?></span><br>
                                <span><b>Status : </b><?php echo FETCH("SELECT * FROM invoices where InvoiceId='$InvoiceId'", "InvoiceStatus"); ?></span><br>
                                <span><b>Paid Date : </b><?php echo DATE_FORMATE("d M, Y", FETCH("SELECT * FROM invoices where InvoiceId='$InvoiceId'", "InvoicePaidAt")); ?></span><br>
                            </span>
                        </p>
                    </td>
                    <td>
                        ...
                        <p>
                            <span><b>Internal RefId : </b> <?php echo DATE_FORMATE("d/m/Y/", FETCH("SELECT * FROM invoice_transactions where InvoiceMainId='$InvoiceId'", "PaymentDate")); ?><?php echo FETCH("SELECT * FROM invoice_transactions where InvoiceMainId='$InvoiceId'", "InvoiceTransactionId"); ?></span><br>
                            <span><b>Payment Date : </b><?php echo DATE_FORMATE("d M, Y", FETCH("SELECT * FROM invoice_transactions where InvoiceMainId='$InvoiceId'", "PaymentDate")); ?></span><br>
                            ...
                            <span><b>Payment Created At : </b><?php echo DATE_FORMATE("d M, Y", FETCH("SELECT * FROM invoice_transactions where InvoiceMainId='$InvoiceId'", "InvoicetxnCreatedAt")); ?> </span><br>
