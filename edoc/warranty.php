        ...
        <tr>
          ...
          <td>
            <p style="margin-left:1rem;">
              ...
              <?php
              $FetchAddress = FETCH_TABLE_FROM_DB("SELECT * FROM user_addresses where UserAddressUserId='$WarrantyCustomerId'", true);
      ...
      <table style="width:100%;margin-top:5px;">
        ...
        <tr>
          <td>
            ...
            <span>
              <?php echo DATE_FORMATE("d M, Y", FETCH($WarnSql, "WarrantyProductMfgDate")); ?></span>
          </td>
          <td>
            <b style="color:black;">Sale Date</b><br>
            <span> <?php echo DATE_FORMATE("d M, Y", FETCH($WarnSql, "WarrantyProductPurchasedate")); ?></span>
          </td>
          <td>
        ...
        <tr>
          <td>
            ...
            <span><?php echo DATE_FORMATE("d M, Y", FETCH($WarnSql, "WarrantyExpireDate")); ?></span>
          </td>
          <td>
