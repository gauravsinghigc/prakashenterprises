                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-2 form-group">
                                          ...
                                          <select class="form-control" name="UserSalutation">
                                             <?php echo SelectInputOptions(SALUTATION, FETCH($PageSqls, "UserSalutation")); ?>
                                          </select>
                                       </div>
                                       <div class="col-md-4 form-group">
                                          <label>FullName</label>
                                          <input type="text" name="UserFullName" class="form-control" value="<?php echo FETCH($PageSqls, "UserFullName"); ?>" required="">
                                       </div>
                                       <div class="col-md-4 form-group">
                                          <label>Phone Number</label>
                                          <input type="tel" name="UserPhoneNumber" class="form-control" value="<?php echo FETCH($PageSqls, 'UserPhoneNumber'); ?>" required="">
                                       </div>
                                       <div class="col-md-4 form-group">
                                          <label>Email Id</label>
                                          <input type="email" name="UserEmailId" class="form-control" value="<?php echo FETCH($PageSqls, "UserEmailId"); ?>" required="">
                                       </div>
                                       <div class="col-md-2 form-group">
                                          <label>Date of Birth</label>
                                          <input type="date" name="UserDateOfBirth" class="form-control" value="<?php echo FETCH($PageSqls, "UserDateOfBirth"); ?>" required="">
                                       </div>
                                       <div class="col-md-12">
                                          <label>Bio & Profile Info</label>
                                          <textarea class="form-control" name="UserNotes" rows="2"><?php echo SECURE(FETCH($PageSqls, "UserNotes"), "d"); ?></textarea>
                                       </div>
                                       <div class="col-md-12">
