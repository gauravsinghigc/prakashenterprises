         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <table class="table table-striped">
                  ...
                  <tbody>
                     <?php
                     $GetDocumnets = FETCH_TABLE_FROM_DB("SELECT * FROM user_documents where UserDocMainUserid='$REQ_UserId'", true);
                     if ($GetDocumnets == null) {
                        ...
                        foreach ($GetDocumnets as $Documents) {
                           ...
                           <tr>
                              ...
                              <td><?php echo DATE_FORMATE("d M, Y", $Documents->UserDocumentCreatedAt); ?></td>
                              <td>
