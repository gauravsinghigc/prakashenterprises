                      ...
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          if (isset($_GET['UserFullName'])) {
                            ...
                            $AllCustomers = FETCH_TABLE_FROM_DB("SELECT * FROM users where UserFullName like '%$UserFullName%' and UserType='SERVICE_EXECUTIVE' ORDER BY UserId Desc", true);
                          } else {
                            $AllCustomers = FETCH_TABLE_FROM_DB("SELECT * FROM users where UserType='SERVICE_EXECUTIVE' ORDER BY UserId Desc", true);
                          }
