  ...
  <div class="wrapper">
            ...
            <div class="col-12">
              <div class="card card-primary">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <a href="../index.php" class="btn btn-sm btn-secondary"><i class="fa fa-angle-left"></i> View All
                        Complaints</a>
                    </div>
                    <div class="col-md-3">
                      ...
                      <p class="data-list">
                        ...
                        <span class="bold"><a href="tel:<?php echo FETCH($UserSql, "UserPhoneNumber"); ?>"><?php echo FETCH($UserSql, "UserPhoneNumber"); ?></a></span>
                        <span class="pull-right"><a href="tel:<?php echo FETCH($UserSql, "UserPhoneNumber"); ?>" class="btn btn-sm btn-success" style="font-size:0.6rem;margin-top:-1.4rem;"><i class="fa fa-phone"></i>
                            Make A Call</a></span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Email ID</span><br>
                        <span class="bold"><?php echo EMAIL(FETCH($UserSql, "UserEmailId"), "link", "", ""); ?></span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Hospital name</span><br>
                        <span class="bold"><?php echo FETCH($UserSql, "UserCompanyName"); ?></span>
                      </p>
                      <p class="data-list">
                      ...
                      <p class="data-list">
                        ...
                        <span class="bold"><?php echo DATE_FORMATE("d M, Y", FETCH($ProSql, "ComplaintProductMfgDate")); ?></span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Purchase Date</span><br>
                        <span class="bold"><?php echo DATE_FORMATE("d M, Y", FETCH($ProSql, "ComplaintProductPurchaseDate")); ?></span>
                      </p>
                      <p class="data-list">
                        <span class="text-grey">Expire Date</span><br>
                        <span class="bold"><?php echo DATE_FORMATE("d M, Y", FETCH($ProSql, "ComplaintProductWarrantyExpireAt")); ?></span>
                      </p>
                    </div>
                    ...
                    <div class="col-md-4">
                      ...
                      <?php
                        ...
                        <p class="data-list">
                          <span class="text-grey">Reg Person Name</span><br>
                          <span class="bold">(ID<?php echo $ComplaintAssignedTo; ?>)
                            <?php echo FETCH($EmpSQL, "UserFullName"); ?></span>
                        </p>
                        <p class="data-list">
                          <span class="text-grey">Phone Number</span><br>
                          <span class="bold"><a href="tel:<?php echo FETCH($EmpSQL, "UserPhoneNumber"); ?>"><?php echo FETCH($EmpSQL, "UserPhoneNumber"); ?></a></span>
                          <span class="pull-right"><a href="tel:<?php echo FETCH($EmpSQL, "UserPhoneNumber"); ?>" class="btn btn-sm btn-success" style="font-size:0.6rem;margin-top:-1.4rem;"><i class="fa fa-phone"></i>
                              Make A Call</a></span>
                        </p>
                        <p class="data-list">
                          <span class="text-grey">Email ID</span><br>
                        ...
                        <a onclick="Databar('AddServiceEnginer')" class="btn btn-sm btn-dark mb-2 mx-auto d-block">Update Service
                          Executive</a>
                      <?php } ?>
                          ...
                          <div class="row">
                            <div class="col-md-12 form-group">
                              <select name="ComplaintAssignedTo" onchange="Form.submit()" class="form-control" required="">
                                ...
                                <?php $FetchExecutive = FETCH_TABLE_FROM_DB("SELECT * FROM users where UserType='SERVICE_EXECUTIVE'", true);
                                if ($FetchExecutive != null) {
                                  foreach ($FetchExecutive as $Ex) { ?>
                                    <option value="<?php echo $Ex->UserId; ?>"><?php echo $Ex->UserFullName; ?> @
                                      <?php echo $Ex->UserPhoneNumber; ?></option>
                                <?php }
                                } ?>
                              </select>
                            </div>
                            <div class="col-md-12">
                              <button type="submit" name="UpdateServiceExecutive" class="btn btn-sm btn-success">Update
                                Executive</button>
                      ...
                      <div class="chat-box">
                        <div class="chat-area">
                          ...
                          <p class="data-list">
                            ...
                            <span class="text-grey">Reg Person Name</span><br>
                            <span class="bold">(ID<?php echo $ComplaintAssignedTo; ?>)
                              <?php echo FETCH($EmpSQL, "UserFullName"); ?></span> @ <a href="tel:<?php echo FETCH($EmpSQL, "UserPhoneNumber"); ?>"><?php echo FETCH($EmpSQL, "UserPhoneNumber"); ?></a><br>
                            <span class="text-grey">Complaint No</span><br>
                          ...
                          <?php $FetchActivity = FETCH_TABLE_FROM_DB("SELECT * FROM complaint_activities where ComplaintMainId='$ComplaintsId' ORDER BY ComplaintActivityId ASC", true);
                            ...
                            foreach ($FetchActivity as $Act) { ?>
                              ...
                              <div class="w-100 <?php echo $pullchat; ?>">
                                <p class="data-list mb-0" <?php echo $color; ?>>
                                  ...
                                  <?php } ?>
                                  <span class="">
                                    <span class="text-grey italic" style="font-size:0.85rem !important;"><?php echo DATE_FORMATE("d M, Y h:i A", $Act->ComplaintActivityDateTime); ?></span><br>
                                  ...
                                  <span class="text-black">
                                    ...
                                    if ($CheckStatusIfReplacementsIsOuccered != null) {
                                      ...
                                      <span>
                                        ...
                                        <span class="bold"><?php echo DATE_FORMATE("d M, Y", FETCH($ReplaceSQL, "ComplaintReplacementMfgDate")); ?></span>
                                      </span><br>

                                      <span>
                                        <span class="text-grey">Warranty : </span>
                                        <span class="bold"><?php echo $WarrantyInMonths = FETCH($ReplaceSQL, "ComplaintReplacementWarrantyMonths"); ?>
                                          Months</span>
                                      </span><br>

                                      <span>
                                        <span class="text-grey">Purchase date : </span>
                                        <span class="bold"><?php echo DATE_FORMATE("d M, Y", $PurchaseDate = FETCH($ReplaceSQL, "ComplaintReplcementPurchasedate")); ?></span>
                                      </span><br>
                                      ...
                                      <span>
                                        ...
                                        <span class="bold">
                                          ...
                                          echo DATE_FORMATE("d M, Y", $ExpireDate);
                                          ?>
                                        </span>
                                      </span><br>
                                      ...
                                      <span>
                                        ...
                                        <span class="bold"><?php echo FETCH("SELECT * FROM users where UserId='" . FETCH($ReplaceSQL, "ComplaintReplacementCreatedBy") . "'", "UserFullName"); ?>
                                          (USERID00<?php echo FETCH($ReplaceSQL, "ComplaintReplacementCreatedBy"); ?>)</span>
                                      </span><br>
                          ...
                          <div class="submitbox">
                            <?php if ($ComplaintVerificationStatus == "UN-VERIFIED" && LOGIN_UserType == "SERVICE_EXECUTIVE") { ?>
                              ...
                              <form action="../../../controller/ComplaintController.php" method="POST">
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    <p style="margin-top:0.5rem !important;">Enter OTP send on customer register phone number, or you can
                                      re send otp</p>
                                  </div>
                                    ...
                                    <div class="col-md-12">
                                      <div id="replacementform" style="display:none;">
                                        ...
                                        <div class="col-md-12 text-right">
                                          <button type="submit" name="AddComplaintActivityRecord" class="btn btn-sm btn-success">Add
                                            Update</button>
                                        </div>
                                      </div>
                                    </div>
    ...
    <script>
      function ShowUpdateForms() {
        ...
        var
          replacementform = document.getElementById("replacementform");
        var
          completionform = document.getElementById("completionform");
        var
          normalupdate = document.getElementById("normalupdate");
