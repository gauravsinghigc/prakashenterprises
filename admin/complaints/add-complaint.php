                  ...
                  <div class="row">
                    <div class="col-md-7">
                      ...
                      <?php if (isset($_GET['UserPhoneNumber'])) {
                        ...
                        <?php
                        $FetchCustomers = FETCH_TABLE_FROM_DB("SELECT * FROM users where UserPhoneNumber like '%$UserPhoneNumber%'", true);
                          ...
                          ?>
                            <div class="data-list">
                              ...
                              <div class="row">
                                ...
                                <?php
                                $Complaints = FETCH_TABLE_FROM_DB("SELECT * FROM complaints where ComplaintsUserId='" . $Customers->UserId . "' ORDER BY DATE(ComplaintCreatedAt) DESC", true);
                                if ($Complaints == null) {
                                ...
                                <form action="../../controller/ComplaintController.php" method="POST">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                      ...
                                      <input type="text" name="UserCompanyName" list="UserCompanyName" value="<?php echo $Customers->UserCompanyName; ?>" class="form-control" placeholder="">
                                      <?php echo SUGGEST("users", "UserCompanyName", "ASC"); ?>
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                      <label>Specialist In</label>
                                      <input type="text" name="UserWorkFeilds" list="UserWorkFeilds" value="<?php echo $Customers->UserWorkFeilds; ?>" class="form-control" placeholder="dental, heart etc">
                                      <?php echo SUGGEST("users", "UserWorkFeilds", "ASC"); ?>
                                    </div>
                                    <div class="col-md-12">
                                      <h5 class="mt-1">Address Details</h5>
                    ...
                    <div class="col-md-5">
                      ...
                      <form action="<?php echo CONTROLLER; ?>/ComplaintController.php" method="POST">
                        ...
                        <div class="row mb-10px">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6">
                            <label>Hospital/Clinic Name</label>
                            <input type="text" name="UserCompanyName" list="UserCompanyName" class="form-control" placeholder="">
                            <?php echo SUGGEST("users", "UserCompanyName", "ASC"); ?>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6">
                            <label>Specialist In</label>
                            <input type="text" name="UserWorkFeilds" list="UserWorkFeilds" class="form-control" placeholder="dental, heart etc">
                            <?php echo SUGGEST("users", "UserWorkFeilds", "ASC"); ?>
                          </div>
                        </div>
                        <div class="row mb-10px">
