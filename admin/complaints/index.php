            ...
            <div class="col-12">
              <div class="card card-primary">
                <div class="card-body">
                          ...
                          <a class="text-white" href="index.php">
                            <h1>
                              ...
                              if (LOGIN_UserType == "SERVICE_EXECUTIVE") {
                                ...
                                echo TOTAL("SELECT * FROM complaints where ComplaintAssignedTo='$loginid' and ComplaintStatus like '%EXECUTIVE ASSIGNE%'");
                              } else {
                                echo TOTAL("SELECT * FROM complaints where ComplaintStatus like '%EXECUTIVE ASSIGNE%'");
                              } ?>
                            </h1>
                            OPEN/EXECUTIVE ASSIGN COMPLAINTS
                          </a>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="mb-2 rounded-2 p-3">
                          <a class="text-white" href="index.php?type=NEW COMPLAINT">
                            <h1>
                              ...
                              if (LOGIN_UserType == "SERVICE_EXECUTIVE") {
                                $loginid = LOGIN_UserId;
                                echo TOTAL("SELECT * FROM complaints where ComplaintAssignedTo='$loginid' and ComplaintStatus like '%NEW COMPLAINT%'");
                              } else {
                                echo TOTAL("SELECT * FROM complaints where ComplaintAssignedTo='' and ComplaintStatus like '%NEW COMPLAINT%'");
                              } ?>
                            </h1>
                            NEW COMPLAINTS
                          </a>
                        ...
                        <div class="mb-2 rounded-2 p-3">
                          <a class="text-white" href="index.php?type=IN PROGRESS">
                            <h1>
                              ...
                              if (LOGIN_UserType == "SERVICE_EXECUTIVE") {
                                $loginid = LOGIN_UserId;
                                echo TOTAL("SELECT * FROM complaints where ComplaintAssignedTo='$loginid' and ComplaintStatus like '%IN PROGRESS%'");
                              } else {
                        ...
                        <div class="mb-2 rounded-3 p-3">
                          <a class="text-white" href="index.php?type=COMPLETED">
                            <h1>
                              ...
                              if (LOGIN_UserType == "SERVICE_EXECUTIVE") {
                                $loginid = LOGIN_UserId;
                                echo TOTAL("SELECT * FROM complaints where ComplaintAssignedTo='$loginid' and ComplaintStatus like '%COMPLETED%'");
                              } else {
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <h6 class="app-sub-heading">All open Complaints or Exectuive Assigned</h6>
                    </div>
                    <?php
                    if (isset($_GET['type'])) {
                      $type = $_GET['type'];
                      if (LOGIN_UserType == "SERVICE_EXECUTIVE") {
                        $loginid = LOGIN_UserId;
                        $Complaints = FETCH_TABLE_FROM_DB("SELECT * FROM complaints where ComplaintAssignedTo='$loginid' and ComplaintStatus like '%$type%' ORDER BY DATE(ComplaintCreatedAt) DESC", true);
                      } else {
                        $Complaints = FETCH_TABLE_FROM_DB("SELECT * FROM complaints where ComplaintStatus like '%$type%' ORDER BY DATE(ComplaintCreatedAt) DESC", true);
                      }
                      ...
                      if (LOGIN_UserType == "SERVICE_EXECUTIVE") {
                        $loginid = LOGIN_UserId;
                        $Complaints = FETCH_TABLE_FROM_DB("SELECT * FROM complaints where ComplaintAssignedTo='$loginid' and ComplaintProductId like '%$ComplaintProductId%' and ComplaintsCustomRefId like '%$ComplaintsCustomRefId%' ORDER BY DATE(ComplaintCreatedAt) DESC", true);
                      } else {
                        $Complaints = FETCH_TABLE_FROM_DB("SELECT * FROM complaints where ComplaintProductId like '%$ComplaintProductId%' and ComplaintsCustomRefId like '%$ComplaintsCustomRefId%' ORDER BY DATE(ComplaintCreatedAt) DESC", true);
                      }
                    } else {
                      if (LOGIN_UserType == "SERVICE_EXECUTIVE") {
                        $loginid = LOGIN_UserId;
                        $Complaints = FETCH_TABLE_FROM_DB("SELECT * FROM complaints where ComplaintAssignedTo='$loginid' and ComplaintStatus like '%EXECUTIVE ASSIGNE%' ORDER BY DATE(ComplaintCreatedAt) DESC", true);
                      } else {
                        $Complaints = FETCH_TABLE_FROM_DB("SELECT * FROM complaints where ComplaintStatus like '%EXECUTIVE ASSIGNE%' ORDER BY DATE(ComplaintCreatedAt) DESC", true);
                      }
                    }
                        ...
                        <div class="col-md-4 col-sm-6 col-12">
                          <a href="details/?id=<?php echo $Complaint->ComplaintsId; ?>">
                            <div class="data-list pb-2">
                              <small class="text-grey italic"><?php echo DATE_FORMATE("d M, Y", $Complaint->ComplaintCreatedAt); ?></small>
                              <span>
                              ...
                              <span>
                                ...
                                <span class="bold">
                                  ...
                                  <br> <i class="fa fa-hospital"></i> <?php echo FETCH("SELECT * FROM users Where UserID='" . $Complaint->ComplaintsUserId . "'", "UserCompanyName"); ?>
