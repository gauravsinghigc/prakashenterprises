  ...
  <div class="row" style="display:block;">
    <table class="table table-striped" style="width:100%;" border="1">
      ...
      if (isset($_GET['ComplaintReplacementModal'])) {
        ...
        $Replacements = FETCH_TABLE_FROM_DB("SELECT * FROM complaint_replacements where ComplaintReplacementModal like '%$ComplaintReplacementModal%' ORDER BY ComplaintReplacementId ASC", true);
      } else {
