                      ...
                      <div class="table-responsive">
                        <table class="table table-striped">
                          ...
                          if (isset($_GET['UserFullName'])) {
                            ...
                            $AllCustomers = FETCH_TABLE_FROM_DB("SELECT * FROM users where UserFullName like '%$UserFullName%' and UserType='Customer' ORDER BY UserId Desc", true);
                          } else {
                            $AllCustomers = FETCH_TABLE_FROM_DB("SELECT * FROM users where UserType='Customer' ORDER BY UserId Desc", true);
                          }
                          ...
                          ?>
                              <tr>
                                ...
                                <td><?php echo $Customers->UserCompanyName; ?></td>
                                <td><?php echo $Customers->UserPhoneNumber; ?></td>
                                <td><?php echo $Customers->UserEmailId; ?></td>
                                <td><?php echo DATE_FORMATE("d M, Y", $Customers->UserCreatedAt); ?></td>
