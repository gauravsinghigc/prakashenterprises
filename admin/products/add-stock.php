                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <table class="table table-striped">
                            ...
                            <?php $GetSerialNo = FETCH_TABLE_FROM_DB("SELECT * FROM product_serial_no where ProductMainProId='$ProductID'", true);
                            $Sno = 0;
                            if ($GetSerialNo != null) {
                              ...
                              foreach ($GetSerialNo as $Data) {
                                ...
                                <tr>
                                  ...
                                  <td><?php echo DATE_FORMATE("d M, Y", $Data->ProductMfgDate); ?></td>
