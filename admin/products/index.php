                    ...
                    <div class="col-md-12">
                      <table class="table table-striped">
                        ...
                        if (isset($_GET['ProductModalNo'])) {
                          ...
                          $Products = FETCH_TABLE_FROM_DB("SELECT * FROM products where ProductModalNo like '%$ProductModalNo%' ORDER BY ProductId ASC", true);
                        } else {
                          $Products = FETCH_TABLE_FROM_DB("SELECT * FROM products ORDER BY ProductId ASC", true);
                        }
                        if ($Products != null) {
                          $Sno = 0;
