      ...
      <div class="row">
        <div class="col-md-12">
          <table class="table table-striped">
            ...
            <tbody>
              <?php
              $fetchSales = FETCH_TABLE_FROM_DB("SELECT * FROM invoices ORDER BY InvoiceId DESC", true);
              if ($fetchSales != null) {
                $Count = 0;
                $TotalSale = 0;
                foreach ($fetchSales as $Sale) {
                  ...
                  <tr>
                    ...
                    <td>
                      <?php echo DATE_FORMATE("d M, Y", $Sale->InvoiceDate); ?>
                    </td>
                    <td>
                      <?php echo DATE_FORMATE("d M, Y", $Sale->InvoiceCreatedAt); ?>
                    </td>
                    <td>
