    ...
    <div id="content" class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-7">
            ...
            <form action="<?php echo CONTROLLER; ?>/order.php" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-md-3 form-group">
                  ...
                  <input type="date" value="<?php echo DATE_FORMATE("Y-m-d", FETCH($ProSerialNoSql, "ProductMfgDate")); ?>" name="ProductMfgDate" class="form-control">
                </div>
          ...
          <div class="row mt-5px">
            <div class="col-md-12">
              <?php $FetchCartItems = FETCH_TABLE_FROM_DB("SELECT * FROM products, invoice_cart where products.ProductId=invoice_cart.InvoiceCartProductId and InvoiceCartCustomerId='$customer_id' group by InvoiceCartProductId", true);
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <p class="mb-0px fs-12px">
                          ...
                          <b>Serial Nos:</b>
                          <?php
                          $GetSno = FETCH_TABLE_FROM_DB("SELECT * FROM products, invoice_cart where products.ProductId=invoice_cart.InvoiceCartProductId and InvoiceCartCustomerId='$customer_id' and InvoiceCartProductId='$InvoiceCartProductId'", true);
                          if ($GetSno != null) {
