...
function PaymentDetails($TransactionId)
{
    ...
    if ($PaymentMode == "CASH") {
        ...
        $TransactionCashReceivedAt = DATE_FORMATE("d M, Y", FETCH("SELECT * FROM transaction_cash where TransactionCashMainTxnId='$TransactionId'", "TransactionCashReceivedAt"));
  ...
  ";
        ...
        $TransactionBankTxnDate = DATE_FORMATE("d M, Y", FETCH("SELECT * FROM transaction_bank_transfer where TransactionBankMainTxnId='$TransactionId'", "TransactionBankTxnDate"));
        ...
        $TransactionBankCreatedAt = DATE_FORMATE("d M, Y", FETCH("SELECT * FROM transaction_bank_transfer where TransactionBankMainTxnId='$TransactionId'", "TransactionBankCreatedAt"));
        $TransactionBankUpdatedAt = DATE_FORMATE("d M, Y", FETCH("SELECT * FROM transaction_bank_transfer where TransactionBankMainTxnId='$TransactionId'", "TransactionBankUpdatedAt"));
